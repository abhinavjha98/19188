    ...
    <form role="form" method="post" id="reused_form">
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>1. I attend program related to my subject.</label>
                                <p>
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>2. I pursue my interest and hobbies and opt to choose career at appropriate stage </label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a.  Does not suit me
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>3. I Enjoy doing mathematical calculation.</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a.  Does not suit me
                           ...
                           <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>4. I follow ideas that comes first in my mind.</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a.  Does not suit me
