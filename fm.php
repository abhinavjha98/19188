    ...
    <form role="form" method="post" id="reused_form">
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>1.Is your current working environment and home environment good?</label>
                                <p>
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>2.Does your economical conditions stress you out?</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a. Yes
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>3.Do you face any transportation issues?</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a. Yes
                           ...
                           <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>4.Do health issues bother you?</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a. Yes
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>5. Is there any kind of violence you are facing?(Call this for contact:100)</label>
                                 <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a. Yes
...
<button>
    <input type="button" name="button" ><a href="previousdata.html"></a>
    </button>
<script >
