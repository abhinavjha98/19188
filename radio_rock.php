    ...
    <form role="form" method="post" id="reused_form">
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>1.I watch sports calmy.</label>
                                <p>
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>2. I can do many things at a time and properly</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a.  Does not suit me
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>3. I continue to do things until they are perfect</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a.  Does not suit me
                           ...
                           <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>4. I work hard to become better than others.</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a.  Does not suit me
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>5. I panic before exam</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a.  Does not suit me
