...
<div class="container">
    <form role="form" method="post" id="reused_form">
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>2. Willing to accept new things upcoming in your life irrespective of its realtion with subject or not.</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a.  Does not suit me
...
<button type="button">next</button><a href="ko.php"></a>
<?php
