    ...
    <form role="form" method="post" id="reused_form">
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>1.I speak loudly to dominate others</label>
                                <p>
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>2. I complete my work successfully</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a.  Does not suit me
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>3. I do not do anything which will hurt others</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a.  Does not suit me
                           ...
                           <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>4. I don’t waste my time in solving other’s problem</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a.  Does not suit me
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>5. I get easily influenced by others.</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a.  Does not suit me
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>7. I attend program related to my subject</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a.  Does not suit me
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>8. I try to find meaning in information in which there is no order.</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a.  Does not suit me
