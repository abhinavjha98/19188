    ...
    <form role="form" method="post" id="reused_form">
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>1.I get easily influenced by motivators.</label>
                                <p>
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>2.Do you argue to prove your point?</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a.  Does not suit me
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>3.Do you consider the review you receive?.</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a.  Does not suit me
                           ...
                           <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>4.You do not easily initiate conversation.</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a.  Does not suit me
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label>5.You often feel lost in your thoughts that you ignore your surroundings.</label>
                                <p>
                                    <label class="radio-inline">
                                        <input type="radio" name="experience" id="radio_experience" value="bad" >
                                        a.  Does not suit me
